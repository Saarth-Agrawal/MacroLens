...
| Live evidence-role safeguard | Passed | Titles, Tavily snippets and unrated domains cannot be upgraded to “Supports” |
| Contradiction safeguard | Passed | Explicit negation, refutation and reversed direction become “Contradicts” and prevent High confidence |
| Source eligibility safeguard | Passed | Lookalike domains and publisher display names cannot spoof an official source |
| Confidence safeguard | Passed | High requires complete factual-claim coverage and no eligible contradiction or unresolved causal claim |
...
|---|---|---|
| Typed English headline | Passed locally | Exact $40T claim returned High from eligible read sources; a deliberate false Moon claim returned Low with zero confirmations |
...
| Conflicting sources | Passed automatically | An eligible contradiction prevents High and leaves the affected claim unverified |
...
- Tavily live retrieval passed locally; the hosted environment still requires its server-side key and a final deployment check.
